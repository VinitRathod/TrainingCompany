  ...
  <head>
    ...
    <style>
      .text p{
        ...
        letter-spacing: 4px;
        overflow: hidden;
        background: linear-gradient(90deg, rgb(0, 3, 165), #fff, rgb(255, 0, 0));
          ...
          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                ...
                <li><a href="training.php" class="nav-link">Corporate Training</a></li>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('images/hero_1.jpg');">
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-md-8 text-center testimony">
            <img src="images/C3.jpeg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
            <h3 class="mb-4">Training Company</h3>
            <blockquote>
              <p>&ldquo; Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laborum delectus repudiandae eum eveniet, perferendis quia dolore, officiis libero accusantium autem fugiat, vel hic placeat aspernatur. &rdquo;</p>
            </blockquote>
          </div>
        </div>
      </div>
      ...
      <div class="site-section courses-title" id="courses-section">
        <div class="container">
          <div class="row mb-5 justify-content-center">
            <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="">
              <h2 class="section-title">Employees From the Company</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="owl-carousel col-12 nonloop-block-14">
            ...
            <div class="course bg-white h-100 align-self-stretch">
              <figure class="m-0">
                <img src="images/C1.jpeg" alt="Image" class="img-fluid">
              </figure>
              <div class="course-inner-text py-4 px-4">
             
                <h3><a href="#">Company1</a></h3>
            ...
            <div class="col-lg-4 ml-auto align-self-start"  data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="p-4 rounded bg-white why-choose-us-box">
                ...
                <div class="d-flex align-items-center custom-icon-wrap custom-icon-light mb-3">
                  ...
                  <div><h3 class="m-0">2,931 Yearly Graduates interns Training</h3></div>
                </div>
  
                <div class="d-flex align-items-center custom-icon-wrap custom-icon-light mb-3">
                  <div class="mr-3"><span class="custom-icon-inner"><span class="icon icon-university"></span></span></div>
                  <div><h3 class="m-0">50 Universities Worldwide interns Training</h3></div>
                </div>
              ...
              <form method="post" action="index.php#contact-section" data-aos="fade" id="contact_form">
                <div class="form-group row">
                  <div class="col-md-12">
                    ...
                    <input type="text" name="name" id="contact_fullname" class="form-control" placeholder="Full name" >
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    ...
                    <textarea class="form-control" id="contact_message" name="message" cols="30" rows="10" placeholder="Write your message here."></textarea>
                  </div>
                </div>
