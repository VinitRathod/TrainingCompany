  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="userDashboard.php" target="_blank">User profile</a>
            ...
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="media align-items-center">
                <span class="avatar avatar-sm rounded-circle">
                  <img alt="Image placeholder" src="images/Profile14.png">
                </span>
    ...
    <!-- Header -->
    <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 600px; background-image: url(https://irp-cdn.multiscreensite.com/4d8ea012/dms3rep/multi/Flat-Design-Character-business-woman.gif); background-size: cover; background-position: center top;">
      <!-- Mask -->
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            ...
            <a href="userDashboard1.html" class="btn btn-info">Do you want to become a trainer?</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
          ...
          <div class="card card-profile shadow">
              ...
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="userDashboard.php">
                    <img src="images/Profile14.png" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                ...
                <div>
                  <i class="ni education_hat mr-2"></i>Organization Name
                </div>
                <hr class="my-4">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              <form>
                <h6 class="heading-small text-muted mb-4">Enrolled courses</h6>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-md-12">
                              ...
                              while($row = mysqli_fetch_assoc($result)){
                                  $output .= "
                                            <tr>
                                              ...
                                              <td class='text-left'>".$row['payment_id']."</td>
                                              <td class='text-left'>".$row['receipt']."</td>
      ...
      <div class="col-xl-6 m-auto text-center">
        <h3>About Us</h3>
            ...
            <div class="col-md-3 ml-auto" >
              <h3>Links</h3>
        <ul class="list-unstyled footer-links" style="list-style-type:none; padding-right: 40px;">
