var activeDropdown = {};
document.getElementById('course-dropdown').addEventListener('click',showDropdown);
document.getElementById('city-dropdown').addEventListener('click', showDropdown); 
document.getElementById('deliveryMode-dropdown').addEventListener('click', showDropdown);                                                              
